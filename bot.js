...
const LOJA = [
  ...
  },
  {
    ...
    preco: 5000,
    tipo: "item",
    descricao: "Muta alguém por 5 minutos. Use: /usar silenciador",
  },
  {
    id: "apelido",
    nome: "🏷️ Apelido",
    preco: 1000,
    tipo: "item",
    descricao: "Muda o apelido de alguém por 1h. Use: /usar apelido",
  },
  {
    id: "caixa",
    ...
    preco: 5000,
    tipo: "item",
    descricao: "Ganhe entre 100 e 10.000 ZéCoins aleatório. Use: /usar caixa",
  },
];

// Inventário dos jogadores { userId: { itemId: quantidade } }
const inventarios = {};
  ...
  if (interaction.commandName === "usar") {
    ...
    // ---- APELIDO ----
      ...
      try {
        ...
        // Restaura o apelido original após 1 hora
        setTimeout(async () => {
          try {
